...
<p align="center">
  <b>🔍 Detailed View</b> · <a href="README.md">📋 List View</a> · <a href="CONTRIBUTING.md">Contributing</a> · <a href="docs/ROADMAP.md">Roadmap</a>
</p>
...
- [2. Token-Level Exploration](#2-token-level-exploration)
  ...
  - [2.5 Summary of Token-Level Methods](#25-summary-of-token-level-methods)
...
- [8. Related Topics](#8-related-topics)
  - [8.1 Model Ensembling](#81-model-ensembling)
  - [8.2 Hidden State Noise & Layer-wise Analysis](#82-hidden-state-noise--layer-wise-analysis)
  - [8.3 Rubric-based Training & Evaluation](#83-rubric-based-training--evaluation)
